...
[gcc pre-C++11/C++11 ABI support](#gcc-pre-c11c11-abi-support)  
...
### gcc pre-C++11/C++11 ABI support
if your library is used by both pre-C++11 ABI and C++11 ABI clients - [here is a guide for pre-C++11/C++11 ABI support](./abi0.md)
